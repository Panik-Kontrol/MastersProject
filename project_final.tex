...
\title{Combining TSL and CASA Into Single Tool For Generating Good-Enough Test Frame Coverage}
...
% in place of "Advisor"
\advisor{Elena Sherman, Ph.D.} % also the chair of your committee
...
\committeeA{Gaby Dagher, Ph.D.} 
\committeeB{Bogdan Dit, Ph.D.}
...
\acknowledgments{
The author wishes to express gratitude to Boise State University and the
Computer Science department for offering a challenging and rewarding program
that graduates feel proud to have undertaken towards their personal growth
and goals for their lives. If the faculty and coarse offerings weren't
excellent, we wouldn't come back to torture ourselves.
}
...
\dedication{For my wife, who pushed me to grow, and for my children.}
...
\section{Background}
\subsection{Category Paritioning Method}
% What is cpm and how tsl works (provide examples, etc)
% Talk about original implementation is C and conversion to C++
\subsection{Combinatorial Interaction Testing}
% What is cit and how casa works (provide examples, input format, etc)
%
\section{Preliminary Work}
% Work I have done so far
\section{Proposed Work}
% Describe the work that needs to be done
% Lay out the steps and timeline for getting milestones completed
% How will success be measured
% This is an agreement with the committee about what work will be done
% This will be agreed upon at the proposal presentation
